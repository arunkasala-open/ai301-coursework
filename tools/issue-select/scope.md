...
I mainly write Python, with some JavaScript. I want to use this course to get
more comfortable reading and navigating unfamiliar codebases, and to get
practice writing tests and following an existing project's conventions
rather than my own. I'd rather avoid issues that are pure frontend/CSS
styling work, since that's not where I'm trying to build skill right now.
